...
또 `ShelterNow`처럼 현재 위치 기준으로 가까운 무더위쉼터, 한파쉼터, 민방위대피소, 임시주거시설을 탐색하고 운영 상태 필터와 거리/수용인원 정렬을 제공하는 공공 안전 서비스도 새로 추가하고 있습니다.
...
- [shelter-now-backend](https://github.com/giwon1130/shelter-now-backend)
  현재 위치 기준으로 가까운 무더위쉼터, 한파쉼터, 민방위대피소, 임시주거시설을 탐색하고 운영 상태 필터와 거리/수용인원 정렬, 지도형 UI와 리스트를 함께 제공하는 공공 안전 서비스 백엔드
