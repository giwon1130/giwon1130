...
최근에는 `MetroPulse`처럼 실시간 지하철 도착정보 OpenAPI와 혼잡도 데이터, 환승역 다중 노선 표시, 노선도형 맵 탐색, 시계열, 출근길 알림을 함께 다루는 교통 서비스도 새로 확장하고 있습니다.
...
- [metro-pulse-backend](https://github.com/giwon1130/metro-pulse-backend)
  실시간 지하철 도착정보 OpenAPI와 30분 단위 평균 혼잡도, 환승역 다중 노선 표시, 노선도형 맵 탐색, 혼잡도 시계열, 출근길 알림을 함께 제공하는 교통 서비스 백엔드
