...
**제품 개발자 · Product-minded Full-stack Developer**

문제를 제품 단위로 정리하고, 실제로 동작하는 형태까지 빠르게 연결합니다.  
Turning fuzzy problems into shipped services — backend, web, mobile.
...
[![Notion](https://img.shields.io/badge/Portfolio-000000?style=flat-square&logo=notion&logoColor=white)](https://www.notion.so/dev-giwon/ce2318d46f3a4b66894ad04d1b20d986)
...
**GIS**  
![GeoServer](https://img.shields.io/badge/-GeoServer-6B9E47?style=flat-square)
...
- 문제를 제품 단위로 정리하고 실제 서비스 형태로 연결 · *Frames problems as products, not features*
- 모호한 요구사항을 문제 정의 → 우선순위 → 실행 단위로 구조화 · *Turns ambiguity into scoped execution*
- AI 도구를 활용해 실험-검증 사이클 단축 · *Shortens experiment-to-validation loops with AI tools*
- 대량 데이터 처리와 조회 성능 개선 · *Large-scale data processing & query performance*
- Kafka·Redis 기반 비동기 처리 구조 설계 · *Async pipelines with Kafka & Redis*
- PostGIS 기반 공간 데이터 처리와 GIS 서비스 개발 · *Spatial data & GIS services*
- 개인 생산성·공공 데이터 영역에서 독립 서비스 MVP를 빠르게 구현 · *Rapid solo MVPs in productivity & civic domains*
...
- GIS 기반 서비스와 **디지털트윈 플랫폼** 백엔드 개발·배포·운영

> 실무 대표 프로젝트는 보안상 공개 저장소로 올릴 수 없어, [Notion 포트폴리오](https://www.notion.so/dev-giwon/ce2318d46f3a4b66894ad04d1b20d986)에 *문제 · 역할 · 해결 방식 · 성과* 중심으로 정리해두었습니다.
...
| Project | Stack | Description |
|---|---|---|
| **giwon-home** — [web](https://github.com/giwon1130/giwon-home) · [api](https://github.com/giwon1130/giwon-home-api) | TS · Kotlin | 공개 프로젝트 허브 & 프로필 카탈로그 API |
| [giwon-assistant-api](https://github.com/giwon1130/giwon-assistant-api) | Kotlin | 아침 브리핑·뉴스/날씨 요약·AI 비서 API |
| [base-spring-template](https://github.com/giwon1130/base-spring-template) | Kotlin | Spring Boot 백엔드 시작 템플릿 |

## 공개 저장소 방향 · Philosophy

공개 저장소는 실무 프로젝트의 원본을 올리는 공간이 아니라, **개인 허브 · 독립 서비스 · 템플릿 · 실험**을 통해 *문제 정의 → 검증 → 개선* 과정을 제품 단위로 정리하는 공간입니다.

Open repos aren't mirrors of work projects — they're where I structure the *define → validate → iterate* loop as independent products, hubs, templates, and experiments.

---

<div align="center">
  <sub><a href="https://www.notion.so/dev-giwon/ce2318d46f3a4b66894ad04d1b20d986">Notion Portfolio</a> · <a href="https://dduckddack-2.tistory.com">Blog</a> · <a href="mailto:gwim1130@naver.com">gwim1130@naver.com</a></sub>
</div>
